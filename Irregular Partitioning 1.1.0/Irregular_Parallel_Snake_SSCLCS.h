...
//double debut, Temps_Calcul = 0, debut_calcul, debut_Comm, Comm = 0, calcul = 0, debut_c;
...
BlockData* arrayDataSplit = NULL;        //Contains the address where the BlockData values are store
char *X = NULL;
char *Y = NULL;
char *Sigma = NULL;
int t,nb_ch, TAILLE_MAX, sizeMaxC, contraintLength, snake_rank, indice_Itteration, diagonal_level, is_begin;
long r, m, s, l, n, k_frag, id_Tmp;
char* partition = NULL;
...
BlockData* fragmentationBlock(BlockData blockdata, int level);
